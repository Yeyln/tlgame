...
printf "
#######################################################################
#       tlgame for CentOS/RedHat 7+                                   #
#       For more information please visit https://gsgameshare.com     #
#######################################################################
"
...
# 取当前目录
tlgame_dir=$(dirname "`readlink -f $0`")
# 进入当前项目目录
pushd ${tlgame_dir} > /dev/null
# 加载进环境变量
. ./versions.txt
. ./options.conf
. ./include/color.sh
